...
export function mountFileWorkflowApp(): void {
...
export function mountFileWorkflowWhenReady(): void {
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', mountFileWorkflowApp, { once: true });
  } else {
    mountFileWorkflowApp();
  }
}
